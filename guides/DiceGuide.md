...
The ~d sigil can be used to generate dice in a way fairly similar to the standard dice notation used by many tabletop games.
...
## Examples
    ...
    iex> [die1, _die2, _die3, _die4] = d.dice
    iex> die1
